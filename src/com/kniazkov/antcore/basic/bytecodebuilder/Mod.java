...
/**
 * Gives the remainder of dividing two numbers from the stack, push the result to the stack
 */
public class Mod extends RawInstruction {
    public Mod(byte selector, int leftSize, int rightSize, int totalSize) {
