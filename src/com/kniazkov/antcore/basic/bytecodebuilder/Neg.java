...
/**
 * Load two values from the stack, perform the negation and push the result to the stack
 */
public class Neg extends RawInstruction {
    public Neg(byte selector, int sizeBefore, int sizeAfter) {
