...
/**
 * Load two values from the stack, perform the right shift operation and push the result to the stack
 */
public class Shr extends RawInstruction {
    public Shr(byte selector, int leftSize, int rightSize, int totalSize) {
