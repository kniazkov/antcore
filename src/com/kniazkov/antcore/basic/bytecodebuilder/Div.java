...
/**
 * divide a number from the stack by another and push the result to the stack
 */
public class Div extends RawInstruction {
    public Div(byte selector, int leftSize, int rightSize, int totalSize) {
