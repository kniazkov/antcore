...
/**
 * Load two values from the stack, perform the disjunction and push the result to the stack
 */
public class Or extends RawInstruction {
    public Or(byte selector, int leftSize, int rightSize, int totalSize) {
