...
/**
 * Load two values from the stack, perform the exclusive OR operation and push the result to the stack
 */
public class Xor extends RawInstruction {
    public Xor(byte selector, int leftSize, int rightSize, int totalSize) {
