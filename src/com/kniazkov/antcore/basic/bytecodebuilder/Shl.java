...
/**
 * Load two values from the stack, perform the left shift operation and push the result to the stack
 */
public class Shl extends RawInstruction {
    public Shl(byte selector, int leftSize, int rightSize, int totalSize) {
