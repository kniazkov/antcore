...
/**
 * Load two values from the stack, perform the inversion and push the result to the stack
 */
public class Not extends RawInstruction {
    public Not(byte selector, int sizeBefore, int sizeAfter) {
