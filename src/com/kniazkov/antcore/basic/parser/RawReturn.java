...
import com.kniazkov.antcore.basic.graph.Return;
 ...
 */
public class RawReturn extends RawStatement {
    public RawReturn(Fragment fragment, TokenExpression expression) {
        super(fragment);
    ...
    public Statement toNode() {
        return new Return(getFragment(), expression != null ? expression.toNode() : null);
    }
