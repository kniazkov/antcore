...
import com.kniazkov.antcore.basic.graph.LeftShift;
import com.kniazkov.antcore.basic.parser.Token;

/**
 * Token represents 'SHL' operator
 */
public class OperatorShl extends Operator {
    @Override
    ...
    private static OperatorShl instance;

    public static Token getInstance() {
        if (instance == null)
            instance = new OperatorShl();
        return instance;
    }
