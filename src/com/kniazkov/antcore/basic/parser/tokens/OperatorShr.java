...
import com.kniazkov.antcore.basic.graph.RightShift;
import com.kniazkov.antcore.basic.parser.Token;

/**
 * Token represents 'SHR' operator
 */
public class OperatorShr extends Operator {
    @Override
    ...
    private static OperatorShr instance;

    public static Token getInstance() {
        if (instance == null)
            instance = new OperatorShr();
        return instance;
    }
