...
/**
 * The node represents 'greater than or equals to' operation, i.e. operation '>='
 */
public class GreaterEqual extends BinaryOperation {
    ...
    public Variant calculate() {
       return left.calculate().greaterEqual(right.calculate());
    }
    ...
    public void genLoad(CompilationUnit unit) throws SyntaxError {
        ...
        unit.addInstruction(new Compare(leftType.getSelector(), ComparatorSelector.GREATER_EQUAL,
