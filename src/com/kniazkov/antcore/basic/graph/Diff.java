...
/**
 * The node represents diff operation, i.e. operation '<>'
 */
public class Diff extends BinaryOperation {
    ...
    public Variant calculate() {
        return left.calculate().diff(right.calculate());
    }
    ...
    public void genLoad(CompilationUnit unit) throws SyntaxError {
        ...
        unit.addInstruction(new Compare(leftType.getSelector(), ComparatorSelector.DIFF,
